...
class Game:
    ...
    def introduction(self):
        ...
        time.sleep(0.8)
        slow_print("Chcete začít [hrát],[načíst] uloženou hru, nebo si [přečíst] návod?"
        ...
        while True:
            ...
            if starting_option == "hrát":
                ...
                slow_print("Návod zatím ještě není k dispozici. \n"
                           "Zmáčkněte enter až budete chtít pokračovat.\n")
                input()
                break
            else:
                wrong_input(0)
    ...
    def difficulty_selection(self):
        ...
        slow_print(" [lehká] - možnost ukládání, málo a lehých soubojů.\n"
                   " [střední] - možnost ukládání, hodně lehkých soubojů.\n"
